  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <ul className="flex flex-col gap-3">
        {teacher && (
          <li className="grid grid-cols-[auto_1fr_1fr_auto_auto] items-center gap-4 rounded-xl border-l-4 border-primary bg-white px-4 py-3 shadow-sm">
            ...
            <div className="w-40 text-sm text-text-disabled">—</div>
            <div className="w-8" />
          </li>
        )}
        ...
        {rows.map((student) => (
          <li
            key={student.id}
            className="grid grid-cols-[auto_1fr_1fr_auto_auto] items-center gap-4 rounded-xl border-l-4 border-primary bg-white px-4 py-3 shadow-sm"
          >
