    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-gray-900 flex items-center justify-center">
                <p className="text-text-body text-body-lg animate-pulse">Loading lessons…</p>
            </div>
        );
    }
    ...
    return (
        ...
        <div>
            <ul className="w-full flex flex-col spacing-xl">
                {lessons.map((lesson) => (
                    <li className="w-full mx-auto p-2 flex flex-wrap justify-between text-body-sm" key={lesson.id}>
